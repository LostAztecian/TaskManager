...
import ru.stoliarenkoas.tm.entity.comparator.task.TaskStartComparator;

import java.io.IOException;
import java.util.Collection;
import java.util.TreeSet;

public class TaskListSortStartCommand extends AbstractCommand {

    @NotNull public static final String NAME = "task-list-sort-start";
    @NotNull private static final String DESCRIPTION = "show all tasks for all projects of a user sorted by start date";
    ...
    public void run() throws IOException {
        ...
        final Collection<Task> allTasks = new TreeSet<>(new TaskStartComparator());
