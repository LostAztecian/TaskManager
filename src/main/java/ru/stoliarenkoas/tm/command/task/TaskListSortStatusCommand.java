...
import ru.stoliarenkoas.tm.entity.comparator.task.TaskStatusComparator;

import java.io.IOException;
import java.util.Collection;
import java.util.TreeSet;

public class TaskListSortStatusCommand extends AbstractCommand {

    @NotNull public static final String NAME = "task-list-sort-status";
    @NotNull private static final String DESCRIPTION = "show all tasks for all projects of a user sorted by status";
    ...
    public void run() throws IOException {
        ...
        final Collection<Task> allTasks = new TreeSet<>(new TaskStatusComparator());
