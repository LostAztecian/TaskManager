...
public class ProjectListSortEndCommand extends AbstractCommand {

    @NotNull public static final String NAME = "project-list-sort-end";
    @NotNull private static final String DESCRIPTION = "show all projects sorted by end date";
    ...
    public void run() throws IOException {
        ...
        final Collection<Project> sortedProjects = new TreeSet<>(new ProjectEndComparator());
