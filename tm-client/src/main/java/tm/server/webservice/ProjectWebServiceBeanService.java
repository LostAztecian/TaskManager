 ...
 * 2019-06-24T11:01:27.013+03:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "ProjectWebServiceBeanService",
                  wsdlLocation = "http://127.0.0.1:80/projectService/?wsdl",
                  targetNamespace = "http://webservice.server.tm/")
@Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-24T11:01:27.013+03:00", comments = "Apache CXF 3.3.2")
public class ProjectWebServiceBeanService extends Service {

    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-24T11:01:27.013+03:00")
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/projectService/?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProjectWebServiceBeanService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/projectService/?wsdl");
        }
        WSDL_LOCATION = url;
    }
