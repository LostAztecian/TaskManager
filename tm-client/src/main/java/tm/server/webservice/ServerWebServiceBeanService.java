 ...
 * 2019-06-24T11:01:27.946+03:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "ServerWebServiceBeanService",
                  wsdlLocation = "http://127.0.0.1:80/serverService/?wsdl",
                  targetNamespace = "http://webservice.server.tm/")
@Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-24T11:01:27.946+03:00", comments = "Apache CXF 3.3.2")
public class ServerWebServiceBeanService extends Service {

    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2019-06-24T11:01:27.946+03:00")
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/serverService/?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServerWebServiceBeanService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/serverService/?wsdl");
        }
        WSDL_LOCATION = url;
    }
